...
public class ProductDTO {
    ...
    @Schema(description = "Nombre del producto", example = "Laptop", maxLength = 100, requiredMode = Schema.RequiredMode.REQUIRED)
    private String name;
    ...
    @Schema(description = "Cantidad del producto", example = "10", requiredMode = Schema.RequiredMode.REQUIRED)
    private Long quantity;

    @NotBlank(message = "La descripción es obligatoria")
    @Size(max = 500, message = "La descripción no puede superar los 500 carateres")
    @Schema(description = "Descripción del producto", example = "Laptop de alta gama", maxLength = 500, requiredMode = Schema.RequiredMode.REQUIRED)
